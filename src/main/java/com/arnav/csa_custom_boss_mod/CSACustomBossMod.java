    ...
    public final class CSACustomBossMod {
        ...
        public CSACustomBossMod(FMLJavaModLoadingContext context) {
            ...
            BuildCreativeModeTabContentsEvent.BUS.addListener(CSACustomBossMod::addCreative);
